...
$uri = "https://wzpdfmihnwcrgkyagwkd.supabase.co/rest/v1/products?description=ilike.*CHILE*&select=id,description,variations"
$response = Invoke-RestMethod -Uri $uri -Headers $headers -Method Get
$response | ConvertTo-Json | Out-File -FilePath "chile_result.json" -Encoding utf8
