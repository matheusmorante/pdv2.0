...
$response = Invoke-RestMethod -Uri "https://wzpdfmihnwcrgkyagwkd.supabase.co/rest/v1/products?select=name&deleted=eq.false" -Headers $headers
$response | Select-Object -ExpandProperty name | ConvertTo-Json
