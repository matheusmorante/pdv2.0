    ...
    return (
        <div className="flex flex-col gap-4">
            ...
            <div className="relative">
                ...
                {/* Results dropdown */}
                {results.length > 0 && (
                    <div className="absolute top-full left-0 right-0 z-10 mt-2 bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 shadow-xl rounded-2xl overflow-hidden animate-in fade-in slide-in-from-top-2">
                        {results.map(prod => (
                            <div key={prod.id}>
